...
const glossary = [
  ...
  {
    term: "席前證婚",
    desc: "證婚儀式於宴會開始之前、另設時段及場地進行，賓客毋須在場見證，新人完成證婚後才正式入座開席。時間表上會獨立佔一個環節，前後包括司儀 / 律師到場、綵排等步驟。",
  },
  {
    term: "入席證婚",
    desc: "證婚儀式插入宴會之中，於正式開席、賓客已經入座之後進行，毋須另外安排時間或場地，程序（宣誓、交換戒指、簽紙等）會嵌入晚宴 / 午宴流程的一部分。",
  },
  {
    term: "行大運",
